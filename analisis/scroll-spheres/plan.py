...
ORDEN = [
    # ── Bloque 1 · arranque en frío ──────────────────────────────────────
    ("Legendary Interaction Between Jackie Chan & Native Americans - Shanghai Noon (2000)",
     "Empezamos por lo único probado: Jackie Chan es el nombre con mejor conversión de todo el cruce, "
     "los dos mayores éxitos de Tengri salen de ahí. Y es el último que queda libre."),
    ("George McFly vs. The Rogue Milkshake 🥤💀 - Back To The Future Blooper",
     "Un blooper de Regreso al futuro no necesita ni una palabra traducida, y la marca la reconoce "
     "todo el mundo en medio segundo. El segundo vídeo tiene que confirmar de qué va el canal."),
    ...
    ("Why \"The Impossible\" Only Had One Shot To Film The Tsunami Scene",
     "El más pequeño de los verdes en el original y aun así va aquí: es una película española de Bayona. "
     "Esa ventaja no la recoge ningún número de un canal inglés."),
    ...
    ("How Return Of The King Shot Saruman's Body Sinking",
     "El Señor de los Anillos es de las marcas más fuertes que hay aquí, y el «cómo se hizo» es el formato "
     "que mejor le funciona al canal original."),
    ("Breaking the Cycle - Mockingjay Part 2 (2015)",
     "El mayor múltiplo de todo el catálogo: 1.695 veces la mediana de su mes. Saga masiva y momento "
     "que se lee sin contexto."),
    ...
    ("How Did They Do This In 1937 Without Any CGI? - Sh! The Octopus (1937)",
     "23,2 M sin que nadie conozca la película: el truco es el protagonista. Prueba si ese formato "
     "aguanta en castellano, que es información útil para las otras dos de cine antiguo."),
    ...
    ("In Twilight (2008), that iconic forest scene where they glide through the trees wasn't CGI",
     "Crepúsculo trae un público distinto al de los siete anteriores. Ensanchar pronto evita quedarse "
     "encasillado en cine de acción."),
    ("D&D: Honor Among Thieves (2023): Owlbear vs. Sofina",
     "27,9 M y x1.528. La película no funcionó aquí, pero una criatura aplastando a la villana se "
     "entiende sin haberla visto."),
    ("How They Filmed the Pyramid Fall in Apocalypto",
     "Apocalypto tiene mucho tirón en España y es puro «cómo se hizo»."),

    # ── Bloque 3 · profundizar ───────────────────────────────────────────
    ...
    ("Eddie Was Completely Vaporized In Spider-Man 3",
     "Escena conocida con un desenlace discutible: de los pocos que abren conversación en comentarios."),
    ...
    ("Ryan Reynolds Tanked A Real Fighter's Punch",
     "Reynolds, un puñetazo real y una reacción. No hace falta nada más."),
    ...
    ("Everybodys Gangster Till The He Does This - Nobody",
     "Nobody le ha dado a Tengri algunas de sus mejores cifras y esta escena sigue libre."),
    ...
    ("This Shot Quietly Exposes Fight Club’s Twist About Marla & Tyler - Fight Club (1999) Movie Detail",
     "El club de la lucha ya le rindió 1,1 M a Tengri con otra escena. Ojo: nosotros ya hicimos la del "
     "narrador, así que este va de segundo de la película, no de primero."),
